    ...
    try {
      ...
      if (!args.length || args.includes('-h') || args.includes('--help')) {
        ...
        await ctx.replyWithHTML(
          ...
          `Dừng ứng dụng, xóa virtual host / cloud service, xóa DNS CNAME và xóa sạch dữ liệu.\n\n` +
      ...
      await ctx.replyWithHTML(
        ...
        `• Đã xóa sạch cấu hình và dịch vụ liên quan.\n` +
        `• Đã thu hồi tên miền và giải phóng tài nguyên.`
      );
    } catch (error) {
